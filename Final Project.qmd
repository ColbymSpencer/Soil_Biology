...
soil_properties <- 
  ...
  select(-bulk_density_g_cm3, -grametric_moisture_content_percent)
...
```{r}
names(arthopods) <- gsub("s_individuals_per_soil_core", 
                         "_count", 
                         colnames(arthopods))
arthopods |> 
...
mbc |>
  ...
  mutate(
    ...
    ws = gravimetric_moisture_content, 
